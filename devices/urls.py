...
urlpatterns = [
    ...
    path('lost/<int:id>/', views.lostitem_detail, name='lostitem-detail'),
    path('lost/<int:id>/update/', views.lostitem_update, name='lostitem-update'),
    ...
    path('found/<int:id>/', views.founditem_detail, name='founditem-detail'),
    path('found/<int:id>/update/', views.founditem_update, name='founditem-update'),
